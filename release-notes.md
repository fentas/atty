...
## [0.8.0](https://github.com/fentas/atty/compare/v0.7.0...v0.8.0) (2026-06-28)
...
* **attop:** capability report + metrics-off guidance (wizard step 2) ([#505](https://github.com/fentas/atty/issues/505)) ([81eccc4](https://github.com/fentas/atty/commit/81eccc43c887b3106540b254078cb794097f0001))
* **attop:** capability-aware landing + atty-installed check (wizard step 1) ([#504](https://github.com/fentas/atty/issues/504)) ([b21e922](https://github.com/fentas/atty/commit/b21e922cbcd7ad6d230213354d0937e67b9b8660))
* **attop:** consented shell-integration write (wizard step 3b) ([#509](https://github.com/fentas/atty/issues/509)) ([92772e4](https://github.com/fentas/atty/commit/92772e459b52a94c8ba34576d7b227aa7826d449))
* **attop:** dashboard binary skeleton (P2) ([#491](https://github.com/fentas/atty/issues/491)) ([8029e90](https://github.com/fentas/atty/commit/8029e9032cedb634a1ac59ce51ab54e2f1b06a9b))
* **attop:** Fleet panel (P2) ([#494](https://github.com/fentas/atty/issues/494)) ([ed253c8](https://github.com/fentas/atty/commit/ed253c8dcf79e26324ba8930cd9954bbd7be62f2))
* **attop:** Guard panel (P2) ([#493](https://github.com/fentas/atty/issues/493)) ([922ee57](https://github.com/fentas/atty/commit/922ee5715c4e8551b0582a67a8cff8c06b5bac7c))
* **attop:** i18n string table  en + de (P2) ([#498](https://github.com/fentas/atty/issues/498)) ([c626b36](https://github.com/fentas/atty/commit/c626b3677960072e2774e8ec56b06291e7572c5f))
* **attop:** in-app Help screen with the keybinding + env reference ([#501](https://github.com/fentas/atty/issues/501)) ([9dfa103](https://github.com/fentas/atty/commit/9dfa103498fc2b0f6df95fd83e414b1584e4c2d8))
* **attop:** live Home screen + metrics client (P2) ([#492](https://github.com/fentas/atty/issues/492)) ([d976c44](https://github.com/fentas/atty/commit/d976c44cf07d5e65a0573f05d3fcaeb5bcc508ad))
* **attop:** report the daemon compiled features on Setup (wizard step 4) ([#510](https://github.com/fentas/atty/issues/510)) ([f0fcc1b](https://github.com/fentas/atty/commit/f0fcc1b0b41ba1533a42a0d785cef9a86baa0bae))
* **attop:** Setup/Doctor screen (P2) ([#497](https://github.com/fentas/atty/issues/497)) ([fcf18f0](https://github.com/fentas/atty/commit/fcf18f013c3a3722b4d962dd4836ba8690a9d7c1))
* **attop:** shell-integration detection on Setup (wizard step 3a) ([#507](https://github.com/fentas/atty/issues/507)) ([e5183ee](https://github.com/fentas/atty/commit/e5183ee3d952f853c2ea122e8c80a6ecc7bbeb64))
* **attop:** ship the dashboard as an installable binary ([#511](https://github.com/fentas/atty/issues/511)) ([56c3975](https://github.com/fentas/atty/commit/56c3975bcdce835edcce082e5792aca6a3e473fa))
* **attop:** theming  palette + glyph sets (P2) ([#496](https://github.com/fentas/atty/issues/496)) ([0b2b2c8](https://github.com/fentas/atty/commit/0b2b2c88c3bac84e0a8962e6f3e8ac11db637795))
...
* **atty-guard:** configurable eBPF enforcement depth (one_level/ancestry/propagate) ([#478](https://github.com/fentas/atty/issues/478)) ([9fd5df2](https://github.com/fentas/atty/commit/9fd5df2cc0a42c23036995ec9e61db080e20e25f))
...
* **atty-guard:** dashboard metrics API (P1a) ([#487](https://github.com/fentas/atty/issues/487)) ([e326671](https://github.com/fentas/atty/commit/e3266714d69ec3bc71b7559ef91b7af6249bc9c9))
...
* **atty-guard:** runtime security-profile switch (SetProfile RPC + CLI) ([#489](https://github.com/fentas/atty/issues/489)) ([369666f](https://github.com/fentas/atty/commit/369666f4310423504f4c928e4c5ee4f30c5d3312))
* **atty-guard:** security profiles + smart routing policy (Phase 1) ([#482](https://github.com/fentas/atty/issues/482)) ([968ef84](https://github.com/fentas/atty/commit/968ef849038a495afdc3c9cb74e7c9ade6c6c778))
* **atty-guard:** security profiles Phase 2  WATCH scope + audit/session ([#483](https://github.com/fentas/atty/issues/483)) ([d1c3bf6](https://github.com/fentas/atty/commit/d1c3bf62c48dd087073818e742aafc18df4499e7))
* **atty-guard:** security profiles Phase 3 A  strict binary deny-map ([#484](https://github.com/fentas/atty/issues/484)) ([25f4a18](https://github.com/fentas/atty/commit/25f4a181216aca8e2e72617475f11eb4e32fe056))
* **atty-guard:** security profiles Phase 3 A+  strict basename deny via bpf_loop ([#485](https://github.com/fentas/atty/issues/485)) ([f2ce567](https://github.com/fentas/atty/commit/f2ce567f21a0a96f5e61d79c260423309dd6829c))
...
* **bench:** add zig build bench harness + benchmarking plan ([#477](https://github.com/fentas/atty/issues/477)) ([2438e8a](https://github.com/fentas/atty/commit/2438e8ab51bba6c3c4a4c3e4d308074898d54f99))
...
* **llm:** #: prompt ’ LLM command generation, async via worker thread ([eb230f4](https://github.com/fentas/atty/commit/eb230f432ce42bd277e9f6298301c8f7d82922ec))
* **llm:** add Gemini CLI provider presets ([#471](https://github.com/fentas/atty/issues/471)) ([dff1a62](https://github.com/fentas/atty/commit/dff1a6244d1c39b2f69c95bdf420805286d09feb))
...
* **llm:** chat panel polish  held arrows repaint, Up/Down nav, Ctrl+C clears ([#392](https://github.com/fentas/atty/issues/392)) ([07caf7b](https://github.com/fentas/atty/commit/07caf7b3e20782ba8357daf6d3057b7ea7c66200))
...
* **llm:** chat recall resumes the same provider session ([#406](https://github.com/fentas/atty/issues/406)) ([29b6275](https://github.com/fentas/atty/commit/29b6275a1c988186d9d8d20f7e1a900b5e0c9eb1))
* **llm:** chat scroll  Alt+PageUp/Down bindings + max-offset clamp fix ([#412](https://github.com/fentas/atty/issues/412)) ([debb5db](https://github.com/fentas/atty/commit/debb5db2cac7aefa3d5fdb710c9b4336d13183ac))
...
* **llm:** memorize chat panel height across panel close ([#405](https://github.com/fentas/atty/issues/405)) ([a66fede](https://github.com/fentas/atty/commit/a66fede99b0af023764825f3e2946ade52e6e139))
...
* **llm:** multi-line chat input  bracketed paste + Alt+Enter ([#390](https://github.com/fentas/atty/issues/390)) ([a838655](https://github.com/fentas/atty/commit/a83865555eac86343a0a2bba7fb5ae77170a0ee2))
...
* **llm:** per-provider prompt extensions for agentic CLIs ([#473](https://github.com/fentas/atty/issues/473)) ([8dd3c59](https://github.com/fentas/atty/commit/8dd3c59bde1e2406b79cf07af3bc7d801f00eecd))
...
* **llm:** timeline-rail prefixes for chat turns (Proposal G v1) ([#404](https://github.com/fentas/atty/issues/404)) ([75d4c67](https://github.com/fentas/atty/commit/75d4c67c4b2f24c186108217a109526c79b0ac02))
...
* **makefile:** `make register-shell` adds atty to /etc/shells ([#389](https://github.com/fentas/atty/issues/389)) ([5a20920](https://github.com/fentas/atty/commit/5a2092058902c1714da39ec653b9a50aa7e70ff3))
* **metrics:** metrics_exporter module (dashboard P1b) ([#488](https://github.com/fentas/atty/issues/488)) ([bfbafb4](https://github.com/fentas/atty/commit/bfbafb45c23e02e7195dc6183dc497ad013c7870))
...
* **sandbox:** Tier-B per-mode eBPF overhead benchmark (Phase 3) ([#479](https://github.com/fentas/atty/issues/479)) ([0d915c9](https://github.com/fentas/atty/commit/0d915c987e7934c13ebee2b1969cff8d3b7b3450))
...
* **security_guard:** configurable Alt+P profile-switch mode with sudo default ([#502](https://github.com/fentas/atty/issues/502)) ([c469389](https://github.com/fentas/atty/commit/c469389f6f2fe41ac0cb005dd99ce12bd92cf0e4))
...
* **security_guard:** in-atty profile switch (Alt+P) + statusbar indicator ([#490](https://github.com/fentas/atty/issues/490)) ([d989a4e](https://github.com/fentas/atty/commit/d989a4ee77fcd628d513fdd35b2e84d8d382e9d2))
...
* **security_guard:** PID-tree threat marking + statusbar =á indicator ([4cc5085](https://github.com/fentas/atty/commit/4cc508512f9141527b9e9d3f34602db07cbf0fee))
...
* **test:** atty ” guard ” SLM integration test framework ([#136](https://github.com/fentas/atty/issues/136)) ([2380f80](https://github.com/fentas/atty/commit/2380f809b4a563395b0d85994652c59b3962f4cd))
...
* **atty-guard:** arm/clear the kernel deny-map on runtime profile switch ([#499](https://github.com/fentas/atty/issues/499)) ([224de04](https://github.com/fentas/atty/commit/224de040bd0e7cdfa3433fa1b998e827cac32569))
...
* **atty-guard:** authorize warn-event subscriptions + bound subscriber slots ([#440](https://github.com/fentas/atty/issues/440)) ([85befe1](https://github.com/fentas/atty/commit/85befe11cb391b942c42fd9e3983ad1fa8f448ff))
* **atty-guard:** bound classify reason/matched + trust_list to the client read buffer ([#450](https://github.com/fentas/atty/issues/450)) ([d3dd144](https://github.com/fentas/atty/commit/d3dd144300dbcd1888138d0bea9f4f7d7b4c6f2b))
...
* **atty-guard:** build+install the BPF object on --with-ebpf; add CAP_MAC_ADMIN ([#442](https://github.com/fentas/atty/issues/442)) ([6ac34a1](https://github.com/fentas/atty/commit/6ac34a1117e434f2811cded21d2446ee3d43a561))
* **atty-guard:** char-boundary-safe slicing in npm_parser + osv (no UTF-8 panic) ([#448](https://github.com/fentas/atty/issues/448)) ([fdab771](https://github.com/fentas/atty/commit/fdab771940c42393e9cf06170337e1d413438732)), closes [#421](https://github.com/fentas/atty/issues/421)
* **atty-guard:** count distinct signals (not raw hits) for auto-Block ([#441](https://github.com/fentas/atty/issues/441)) ([9db90dd](https://github.com/fentas/atty/commit/9db90dd63b01a778ccac8048dcbe21be58142059))
* **atty-guard:** fsync the sibling atomic-write paths ([#468](https://github.com/fentas/atty/issues/468)) ([27e26be](https://github.com/fentas/atty/commit/27e26be28eb271eb94d0230692b692a9830f2016))
* **atty-guard:** fsync write_atomic and set perms before rename ([#459](https://github.com/fentas/atty/issues/459)) ([8153f7d](https://github.com/fentas/atty/commit/8153f7d5607c2c600448a0d2a4de0e04d34fd54c))
* **atty-guard:** gate classify pid upgrade cross-UID + cap OSV fan-out ([#451](https://github.com/fentas/atty/issues/451)) ([0a51b4f](https://github.com/fentas/atty/commit/0a51b4f524f3bef7daafcc0a4af3ff2cb27e8aad))
...
* **atty-guard:** harden the atom-fetch pipeline (accumulation cap, quality gate, write perms) ([#449](https://github.com/fentas/atty/issues/449)) ([6cbbdaa](https://github.com/fentas/atty/commit/6cbbdaa3f24712e6185bce5073525d5666ebac69))
...
* **atuin:** order autosuggestions newest-first via --reverse ([#474](https://github.com/fentas/atty/issues/474)) ([bb27e35](https://github.com/fentas/atty/commit/bb27e3591b5b4112d1fafe8042b9fd811cdb17f9))
...
* **ci:** release-please squash-merge auto-tag + populate Release body ([#133](https://github.com/fentas/atty/issues/133)) ([852a7de](https://github.com/fentas/atty/commit/852a7de79f636a61db26ce30df962cf344941642))
...
* **config:** default ghost pick-list (list_count) to off ([#453](https://github.com/fentas/atty/issues/453)) ([e9125c3](https://github.com/fentas/atty/commit/e9125c3fd27bce02b608215722af88aa8334bc09))
* **config:** ghost.list_count ships off (0) by default ([e9125c3](https://github.com/fentas/atty/commit/e9125c3fd27bce02b608215722af88aa8334bc09))
* **config:** reject unknown config declarations on both sides ([#454](https://github.com/fentas/atty/issues/454)) ([2bf1a9a](https://github.com/fentas/atty/commit/2bf1a9aad8774a54df4a079ee3667c45b8852632))
...
* **cursor_dsr:** gate ESC interception on outstanding query  unblocks Esc bindings ([#135](https://github.com/fentas/atty/issues/135)) ([3af4bae](https://github.com/fentas/atty/commit/3af4bae2b3285bf5139ab77e0db0cd0e2782cdfd))
...
* **history:** seek to tail on load; stream-filter file on delete ([#438](https://github.com/fentas/atty/issues/438)) ([464ffa8](https://github.com/fentas/atty/commit/464ffa8ff27317f0184389e99236de53d7d11b34))
...
* **line_state:** carry partial CSI across reads (no continuation-byte injection) ([#446](https://github.com/fentas/atty/issues/446)) ([3a0c64b](https://github.com/fentas/atty/commit/3a0c64b4edb85e84ff8dceefb925acfca4caa159))
...
* **llm:** chain multi-line exec commands with `&&` so they run as one ([#395](https://github.com/fentas/atty/issues/395)) ([82a09ab](https://github.com/fentas/atty/commit/82a09ab28efcbad6786df6252e529877ab31d733))
...
* **llm:** chat exec continuation stalled when focus parked on shell ([#393](https://github.com/fentas/atty/issues/393)) ([f637ea3](https://github.com/fentas/atty/commit/f637ea33b2ef6526d86806db6bbc9637524ec60a))
...
* **llm:** clamp overlay pick-list rows; musl-safe recall seek; scale worker stack ([#447](https://github.com/fentas/atty/issues/447)) ([e2d9c8f](https://github.com/fentas/atty/commit/e2d9c8f54e821513172514b2c9748ffad572de32))
...
* **llm:** direct recall load + Alt+r resends the last prompt ([#475](https://github.com/fentas/atty/issues/475)) ([da1324b](https://github.com/fentas/atty/commit/da1324b7fd4424e07a373e2928de3b2ae9423f52))
...
* **llm:** exec-no-return  process OSC 133 edges even when dialog idle ([#396](https://github.com/fentas/atty/issues/396)) ([5b2389a](https://github.com/fentas/atty/commit/5b2389ad62794d57ffda06706c7df66ac9256050))
* **llm:** free-text answer to a chat question clears the picker chrome ([#410](https://github.com/fentas/atty/issues/410)) ([75477b0](https://github.com/fentas/atty/commit/75477b01cdbc569544505b82ca991a492e91ac78))
* **llm:** full-screen overlay renders exec turns with the new box ([#408](https://github.com/fentas/atty/issues/408)) ([40165b0](https://github.com/fentas/atty/commit/40165b04ee772917782886225d81a476ef8c4847))
...
* **llm:** inline chat panel  defensive clears for ghost rows ([#411](https://github.com/fentas/atty/issues/411)) ([94940a7](https://github.com/fentas/atty/commit/94940a77d136ec7893a4279377b03dc5d7e14d7f))
...
* **llm:** multi-line exec commands stage as bracketed paste, not && chain ([#409](https://github.com/fentas/atty/issues/409)) ([c69e8d8](https://github.com/fentas/atty/commit/c69e8d8362cbc7c8251f47dd686c74994d422242))
...
* **llm:** preserve chat turns on subprocess timeout + Alt+r retry ([#394](https://github.com/fentas/atty/issues/394)) ([9de14af](https://github.com/fentas/atty/commit/9de14af7b63628f4de19e71de31ce88dd4176eb7))
...
* **llm:** sanitize dialog-mode exec commands before injection ([#437](https://github.com/fentas/atty/issues/437)) ([f247400](https://github.com/fentas/atty/commit/f247400b44589a58a94c83dbc034f690913d1d24))
...
* **llm:** write subprocess stdin from a thread to avoid full-duplex deadlock ([#457](https://github.com/fentas/atty/issues/457)) ([40f2eaa](https://github.com/fentas/atty/commit/40f2eaa68548de39c4f939cc67a055fcbdee0501))
* OS-portable monotonic clock and open flags across modules ([#466](https://github.com/fentas/atty/issues/466)) ([4f1df6e](https://github.com/fentas/atty/commit/4f1df6e345580662c498c9cfd13e8b760a847868))
...
* **proxy:** defer atty paints when shell is mid-escape ([#387](https://github.com/fentas/atty/issues/387)) ([58e2756](https://github.com/fentas/atty/commit/58e275622a01407e8ec737231f721362dbe70e4c))
...
* **proxy:** forward CPR replies to foreground commands ([#470](https://github.com/fentas/atty/issues/470)) ([5d85fca](https://github.com/fentas/atty/commit/5d85fca6d89e88559277d4faf35cf00ed442f23b))
...
* **release:** create releases with assets atomically for immutable releases ([#514](https://github.com/fentas/atty/issues/514)) ([e633301](https://github.com/fentas/atty/commit/e633301de06f8c8a5648be3a5a95b93520c7ca72))
* repo hygiene + Darwin-portable clock and open flags (audit [#435](https://github.com/fentas/atty/issues/435)) ([51be76b](https://github.com/fentas/atty/commit/51be76b580f03e75b76ba8453515080108b04329))
* repo hygiene and Darwin-portable clock/open flags ([#464](https://github.com/fentas/atty/issues/464)) ([51be76b](https://github.com/fentas/atty/commit/51be76b580f03e75b76ba8453515080108b04329))
...
* **security_guard:** re-probe a disabled daemon; seed trust only on success ([#443](https://github.com/fentas/atty/issues/443)) ([4691ebd](https://github.com/fentas/atty/commit/4691ebd86621740220198bc2332a2918a47e159c))
...
* **security_guard:** structural UDS response parse + echoed-id validation ([#452](https://github.com/fentas/atty/issues/452)) ([3a23470](https://github.com/fentas/atty/commit/3a234707991426cd7046c8e15b9c719227c891cb))
...
* **tests:** drop deleted atom_fetcher_lolbas scenario from full run ([#455](https://github.com/fentas/atty/issues/455)) ([ac2c9b7](https://github.com/fentas/atty/commit/ac2c9b77b0de41f05309005ad19b1b87aa725e4d))
...
* **atty-guard:** remove the unconsumed trace_execve tracepoint ([#481](https://github.com/fentas/atty/issues/481)) ([54804cd](https://github.com/fentas/atty/commit/54804cd794c5efce3027bb45a40eab4769464d81))
...
* split hooks_tests into 4 topic-focused siblings ([#400](https://github.com/fentas/atty/issues/400)) ([3dc5607](https://github.com/fentas/atty/commit/3dc560719c5c57df03eccf75742846627024478a))
* split hooks_tests.zig into 4 topic-focused siblings ([3dc5607](https://github.com/fentas/atty/commit/3dc560719c5c57df03eccf75742846627024478a))
* split line_state_tests into input + commit stripes ([#397](https://github.com/fentas/atty/issues/397)) ([69e0acc](https://github.com/fentas/atty/commit/69e0acc92dfb915efeb303c49e846c8dfea607c2))
* split line_state_tests.zig into input + commit stripes ([69e0acc](https://github.com/fentas/atty/commit/69e0acc92dfb915efeb303c49e846c8dfea607c2))
* split llm_tests into parse + status stripes ([#401](https://github.com/fentas/atty/issues/401)) ([a22d729](https://github.com/fentas/atty/commit/a22d729c7ead3e897e3a8e4285b3026b6009df83))
* split llm_tests.zig into parse + status stripes ([a22d729](https://github.com/fentas/atty/commit/a22d729c7ead3e897e3a8e4285b3026b6009df83))
* split paint_tests into panel + render + chrome stripes ([#399](https://github.com/fentas/atty/issues/399)) ([0baf52f](https://github.com/fentas/atty/commit/0baf52fdaaab5199ab63a6fd1f02cda9a5e07d98))
* split paint_tests.zig into panel + render + chrome stripes ([0baf52f](https://github.com/fentas/atty/commit/0baf52fdaaab5199ab63a6fd1f02cda9a5e07d98))
* split worker_tests into subprocess + stream stripes ([#398](https://github.com/fentas/atty/issues/398)) ([0f7b3a8](https://github.com/fentas/atty/commit/0f7b3a892ec125513c7625280099e43e120eae00))
* split worker_tests.zig into subprocess + stream stripes ([0f7b3a8](https://github.com/fentas/atty/commit/0f7b3a892ec125513c7625280099e43e120eae00))
...
* add 5 more chat UI/UX proposals (F-J) ([#403](https://github.com/fentas/atty/issues/403)) ([f91119a](https://github.com/fentas/atty/commit/f91119a4692752815627396c1960eaeebbdd0d3c))
...
* added Alt+Shift+R / Alt+r to the llm.md keybinding table and ([452d14e](https://github.com/fentas/atty/commit/452d14e039425c3825a5ea2f00779c9d47d89cbd))
...
* audit tracker for 2026-06-12 full-repo review ([#413](https://github.com/fentas/atty/issues/413)-[#435](https://github.com/fentas/atty/issues/435)) ([b109cee](https://github.com/fentas/atty/commit/b109cee508f828b2875ddd77fc34f4d2cc50a19f))
* audit tracker for 2026-06-12 full-repo review ([#436](https://github.com/fentas/atty/issues/436)) ([b109cee](https://github.com/fentas/atty/commit/b109cee508f828b2875ddd77fc34f4d2cc50a19f))
* chat UI/UX proposals (5 options) ([#402](https://github.com/fentas/atty/issues/402)) ([1b11054](https://github.com/fentas/atty/commit/1b1105435104f56ee178e5529faed5902d57d9e6))
...
* **config:** correct the Terminal section and stale binding/statusbar comments ([#456](https://github.com/fentas/atty/issues/456)) ([fe6c216](https://github.com/fentas/atty/commit/fe6c2168a06b6c6b757c88b3bf0590f16dde2c73))
* **dashboard:** design-of-record for the attop TUI + metrics API ([#486](https://github.com/fentas/atty/issues/486)) ([24c39f5](https://github.com/fentas/atty/commit/24c39f545d9ff5c86e0cb0f28ee4f3c68ccbe3fb))
* document the attop dashboard (screens, themes, i18n, keybindings) ([#500](https://github.com/fentas/atty/issues/500)) ([5121854](https://github.com/fentas/atty/commit/5121854adf730467c10b43468fa1ab0bc0273c56))
* document the attop dashboard and capability wizard ([#512](https://github.com/fentas/atty/issues/512)) ([6c1c77f](https://github.com/fentas/atty/commit/6c1c77f7c5e2a7cd2e8f1458ec54bccb971e7667))
* fix stale CLAUDE/module/atuin/llm comments and invariants ([#463](https://github.com/fentas/atty/issues/463)) ([77fba37](https://github.com/fentas/atty/commit/77fba37b0713d2aa26abda941214933be889aa7d))
...
* image-paste research  protocol survey + phased atty plan ([#407](https://github.com/fentas/atty/issues/407)) ([e01fc80](https://github.com/fentas/atty/commit/e01fc80850b614672fa75cb41be54777f8bada14))
...
* mark [#413](https://github.com/fentas/atty/issues/413) done in audit tracker ([0bc444d](https://github.com/fentas/atty/commit/0bc444d5ac44616ad1131ce121074b4adf83e5c7))
* mark [#414](https://github.com/fentas/atty/issues/414) done in audit tracker ([7209551](https://github.com/fentas/atty/commit/7209551ac5d481fcf7cf3696f5b98216a8d07b63))
* mark [#415](https://github.com/fentas/atty/issues/415) done in audit tracker ([367218e](https://github.com/fentas/atty/commit/367218eacdb76e6a760c0779ba6ca97d409fc344))
* mark [#416](https://github.com/fentas/atty/issues/416) done in audit tracker ([7d92780](https://github.com/fentas/atty/commit/7d92780dfcec058d8253051ef3c04bddecbc8d29))
* mark [#417](https://github.com/fentas/atty/issues/417) done in audit tracker ([bc297b3](https://github.com/fentas/atty/commit/bc297b3e2400d772cb0f9ffc20011ec3f97042b1))
* mark [#418](https://github.com/fentas/atty/issues/418) done in audit tracker ([606d512](https://github.com/fentas/atty/commit/606d512938e649e0d06f054a5c299f4748736645))
* mark [#419](https://github.com/fentas/atty/issues/419) done in audit tracker (keymap prefix-match ’ [#445](https://github.com/fentas/atty/issues/445)) ([d7f4b6f](https://github.com/fentas/atty/commit/d7f4b6ff27ea34e6fa12f7552ed97d1a082cb0f6))
* mark [#420](https://github.com/fentas/atty/issues/420) done in audit tracker ([c90eabc](https://github.com/fentas/atty/commit/c90eabc86547ccb2f5304bffa1ed9b38c0afbad3))
* mark [#421](https://github.com/fentas/atty/issues/421) done in audit tracker ([02ded50](https://github.com/fentas/atty/commit/02ded5078bd2ff8a5a6806d6c828df538ecf58da))
* mark [#422](https://github.com/fentas/atty/issues/422) done in audit tracker ([e2a8b0d](https://github.com/fentas/atty/commit/e2a8b0d61054bd91a7a25b0e5067d72f22745f41))
* mark [#423](https://github.com/fentas/atty/issues/423) done in audit tracker ([11a8b2b](https://github.com/fentas/atty/commit/11a8b2b7ff78633aef4d2dd20383531761564de2))
* mark [#424](https://github.com/fentas/atty/issues/424) done in audit tracker ([0038cf2](https://github.com/fentas/atty/commit/0038cf2c9153feeb310c3af732be12ab61a05dab))
* mark [#425](https://github.com/fentas/atty/issues/425) done in audit tracker ([e5c1452](https://github.com/fentas/atty/commit/e5c1452565638e34cc12362489b5b10975e10cec))
* mark [#426](https://github.com/fentas/atty/issues/426) done in audit tracker ([a48e89b](https://github.com/fentas/atty/commit/a48e89b2532467f1266755ca866d646695c7bf90))
* mark [#427](https://github.com/fentas/atty/issues/427) done in audit tracker ([81b3fce](https://github.com/fentas/atty/commit/81b3fcea3110e1633ff7fa9ed380dd5b8322636c))
* mark [#428](https://github.com/fentas/atty/issues/428) done in audit tracker ([04c900d](https://github.com/fentas/atty/commit/04c900d7bc1419f6d5b3f10256c806c219516636))
* mark [#429](https://github.com/fentas/atty/issues/429) done in audit tracker ([2cfe9c2](https://github.com/fentas/atty/commit/2cfe9c2e3b381c50af864ece67bf49eb2c4fd6bc))
* mark [#430](https://github.com/fentas/atty/issues/430) done in audit tracker ([dc3a323](https://github.com/fentas/atty/commit/dc3a323c70a2a571a9c5af6b82e8a26e299612f8))
* mark [#431](https://github.com/fentas/atty/issues/431) done in audit tracker ([857492e](https://github.com/fentas/atty/commit/857492e752e388f432e0418e58d8ee6cad96731d))
* mark [#432](https://github.com/fentas/atty/issues/432) done in audit tracker ([96269e0](https://github.com/fentas/atty/commit/96269e0d2c5e7d1c243ae8247315a483ed7516ec))
* mark [#433](https://github.com/fentas/atty/issues/433) done (server-side); e2e daemon-verdict deferred to [#461](https://github.com/fentas/atty/issues/461) ([94a49d9](https://github.com/fentas/atty/commit/94a49d99c1e336a88b05faa587fd8659eded570f))
* mark [#434](https://github.com/fentas/atty/issues/434) done in audit tracker ([5ca50ef](https://github.com/fentas/atty/commit/5ca50ef2e96a05a6adad701f43994dc9ce1f3cec))
* mark [#435](https://github.com/fentas/atty/issues/435) done  audit [#413](https://github.com/fentas/atty/issues/413)-[#435](https://github.com/fentas/atty/issues/435) fully closed ([535bf14](https://github.com/fentas/atty/commit/535bf14e9e1491f3acc48820686c3f63c8ff68ae))
...
* record the eBPF enforcement-depth decision rationale ([#480](https://github.com/fentas/atty/issues/480)) ([9a5d643](https://github.com/fentas/atty/commit/9a5d64358606283c70194fb112a4f5b6288a81b0))
...
* rewrite README and refresh the docs set ([#476](https://github.com/fentas/atty/issues/476)) ([452d14e](https://github.com/fentas/atty/commit/452d14e039425c3825a5ea2f00779c9d47d89cbd))
...
* **site:** surface attop on the site and fix the Modules nav affordance ([#513](https://github.com/fentas/atty/issues/513)) ([2050bd6](https://github.com/fentas/atty/commit/2050bd692f4ebba330726210782b52d2d2e21cfc))
